...
public class ConversionAMayaDetalles extends AppCompatActivity {
    TextView numeroP2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conversion_a_maya_detalles);
        ...
        int numeron=intent.getExtras().getInt("numero");
        asignarValores(p2,p1,p0);
        actualizarImagenesNumeros(p2,p1,p0);
        if (p2 != 0) {
            //Toast.makeText(this, "p2:" + p2 + "|||p1:" + p1 + ",|||p0:" + p0, Toast.LENGTH_LONG).show();
            TextView masP1=findViewById(R.id.masP1);
            masP1.setText("+");
    ...
    private void asignarValores(int p2,int p1,int p0) {
        ...
        resultadoTotal.setText(String.valueOf(
                        Integer.parseInt(resultadoP2.getText().toString())+
                        Integer.parseInt(resultadoP1.getText().toString())+
                        Integer.parseInt(resultadoP0.getText().toString())
        ));
    }
